...
这是因为如果$K$对应的index为$n!$的因子，那么相应的商群的阶$|G/K|$也是$n!$的因子。同时群同态$\phi$的核为$K$，以及[[第一同构定理#1. 群上的第一同构定理]]告诉我们$$G/K \simeq \text{im}\phi$$所以群同态的像作为$S(X)$的子群，其阶也是$n!$的因子。那么此时最简单的处理方式就是令$|X|=n$，如此一来$|S(X)|=n!$,那么Lagrange定理告诉我们$\text{im}\phi$作为其子群一定是整除$n!$的。
